...
void Shader_setMat2(GLuint shaderID, const char *name, const GLfloat *mat) {
    glUniformMatrix2fv(Shader_getUniformLocation(shaderID, name), 1, GL_FALSE, mat);
}

void Shader_setMat3(GLuint shaderID, const char *name, const GLfloat *mat) {
    glUniformMatrix3fv(Shader_getUniformLocation(shaderID, name), 1, GL_FALSE, mat);
}

void Shader_setMat4(GLuint shaderID, const char *name, const GLfloat *mat) {
    glUniformMatrix4fv(Shader_getUniformLocation(shaderID, name), 1, GL_FALSE, mat);
}
